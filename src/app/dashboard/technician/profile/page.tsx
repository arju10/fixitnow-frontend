...
export default function TechnicianProfilePage() {
  const { user } = useAuth();
  const { technician, loading, fetchMyProfile, updateProfile } = useTechnicians();
  ...
  }, [user?.id, fetchMyProfile]);

  useEffect(() => {
    if (technician) {
      setFormData({
        bio: technician.bio || '',
        experienceYrs: technician.experienceYrs?.toString() || '',
                  ...
                  <div className="space-y-3 border-t pt-4">
                    ...
                    <div className="flex flex-wrap gap-6">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {technician?.experienceYrs || 0} years
                        </p>
                      </div>
                      <div>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {technician?.services?.length || 0} services
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">Rating</p>
                  <p className="text-sm text-muted-foreground">{technician?.avgRating || 0} / 5</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{technician?.totalReviews || 0}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
